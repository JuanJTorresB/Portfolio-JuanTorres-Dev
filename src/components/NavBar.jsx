...
export const NavBar = () => {
    ...
    }, []); // Este efecto solo se configura una vez al montar el componente
    ...
    return <nav className={(windowWidth >= 1440 ? "gap-32":"gap-34") + " fixed top-0 left-0 right-0 max-w-7xl w-3/4 px-4 h-20 flex justify-evenly bg-amber-100 bg-opacity-10 rounded-full items-center border border-slate-50 backdrop-blur-lg z-10 mx-auto"}>
