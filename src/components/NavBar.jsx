...
export const NavBar = () => {
    ...
    return <nav className={(windowWidth >= 1440 ? "gap-32":"") + " fixed top-0 left-0 right-0 max-w-7xl w-[60vw] px-4 h-20 flex justify-evenly bg-amber-100 bg-opacity-10 rounded-full items-center border border-slate-50 backdrop-blur-lg z-10 mx-auto flex-wrap"}>
        ...
        {(windowWidth >= 1440 ? <svg className="w-16 min-h-16" viewBox="0 0 47 46" fill="none" xmlns="http://www.w3.org/2000/svg">
