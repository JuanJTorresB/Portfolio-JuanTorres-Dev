export const NavBar = ()=>{
    ...
    return <nav className="fixed top-0 left-0 right-0 max-w-7xl px-4 h-20 flex justify-evenly gap-32 bg-amber-100 bg-opacity-10 rounded-full items-center border border-slate-50 backdrop-blur-lg z-10 mx-auto">
            <a href="#AboutMe" className="flex"><h4 identificador="AboutMe"  className={generalLetras}>About Me</h4></a>
        <a href="#Skills"><h4 identificador="Skills" className={generalLetras}>Skills</h4></a>
...
<path d="M10.4993 31.9639C9.63629 31.9639 8.90607 31.8046 8.28649 31.486C7.6669 31.1675 7.35712 30.7958 7.35712 30.371C7.35712 30.1763 7.44563 30.0702 7.66691 30.0702C8.79543 30.0702 9.37075 29.4153 9.37075 28.1056L9.7165 16.0884C9.7165 15.115 7.86606 14.4248 7.35712 14H16.3549C15.8238 14.4248 15.5804 15.115 15.5804 16.0884V27.5039C15.5804 28.9552 15.1379 30.0702 14.2749 30.8312C13.3898 31.5922 11.9155 31.9639 10.4993 31.9639Z" fill="#FEF3C7"/>
        ...
        <a href="#Projects"><h4 identificador="Projects" className={generalLetras}>Projects</h4></a>
        <a href="#Contact"><h4 identificador="Contact" className={generalLetras}>Contact</h4></a>
    </nav>
}