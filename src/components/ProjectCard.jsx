export const ProjectCard = ({name, imgUbi, description, Icons})=>{

    const generalLetras = "font-Ysabeau font-normal text-wrap";
    
    let contador = 1;

    return <article className="bg-amber-100 bg-opacity-10 border border-slate-50 backdrop-blur-lg flex w-[966px] p-14 rounded-[60px] gap-x-7 items-center">
        ...
        <img src={imgUbi} className="h-[270px]" />
    </article>
}